...
//
   ...
   var is_fx_ver = is_moz_ver;
    ...
    // Added by Nicolas Hognon from Virtools    
...
// KNOWN BUG: On AOL4, returns false if IE3 is embedded browser
    ...
    var is_winxp = ((agt.indexOf("windows nt 5.1")!=-1) || (agt.indexOf("windows nt 5.2")!=-1) || (agt.indexOf("windows xp")!=-1)); // 020214 - dmr
    // Added by Nicolas Hognon from Virtools
    ...
    // Added by Nicolas Hognon from Virtools
    var is_win64 = (is_winxp || is_winvista) && ((navigator.platform == "Win64") || (agt.indexOf("win64")!=-1) || (agt.indexOf("64bit")!=-1));
